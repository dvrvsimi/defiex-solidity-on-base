...
ignitionScope
    ...
    .setAction(async ({ modulePath, parameters: parametersInput, deploymentId: givenDeploymentId, defaultSender, reset, verify, }, hre) => {
    ...
    if (reset) {
        if (deploymentDir === undefined) {
            console.warn("Deploy cancelled: Cannot reset deployment on ephemeral Hardhat network");
            process.exit(0);
        }
        else {
